...
class HorizontalFormRendererTest extends Test
{
    ...
    */
    ...
    public function testRenderHorizontalFormWithErrors()
    {
        ...
        $this->assertEquals('<form class="form-horizontal" name="test" method="post" id="test"><div class="has-error  form-group row"><label for="email" class="col-sm-2 col-md-3 control-label"><span class="text-danger">* </span>Email</label><div class="col"><input name="email" type="email" class="form-control" placeholder="Email" id="email"></div><div class="col-sm-offset-2 col-sm-10"><span class="help-block">wtf</span></div></div><div class="has-error  form-group row"><label for="password" class="col-sm-2 col-md-3 control-label"><span class="text-danger">* </span>Password</label><div class="col"><input name="password" type="password" class="form-control" id="password" placeholder="Password"></div><div class="col-sm-offset-2 col-sm-10"><span class="help-block">Value is required and can\'t be empty<br></span></div></div><div class=" form-group row"><label for="choose" class="col-sm-2 col-md-3 control-label">Choose</label><div class="col"><div class="radio"><div class="radio"><label for="choose"><input type="radio" name="choose" value="choose">Choose Me!</label></div><div class="radio"><label for="choose"><input type="radio" name="choose" value="choose2">Or Me!</label></div></div></div></div><div class=" form-group row"><div class="col"><input name="submit" value="Sign in" type="submit" class="btn btn-primary"></div></div></form>'."\n", $html);
    }
}
